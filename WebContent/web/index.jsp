...
<body>
    ...
    <div class="login-form w3_form">
        ...
        <div class="login w3_login">
            ...
            <div class="w3l_grid">
                <form class="login-container" action="http://localhost:8080/baocaoweb/showuser.jsp"  method="post">
                ...
                <div class="bottom-text w3_bottom_text">
                    <p>Bạn chưa có tài khoản ?<a class="btn btn-success" style="color:#ffffff;" href="http://localhost:8080/baocaoweb/jsp/dangkytaikhoanmoi.jsp">Đăng ký</a></p>
