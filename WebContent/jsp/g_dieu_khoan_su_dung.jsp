...
Dù biết rằng bạn rất dễ bỏ qua những Điều khoản dịch vụ này, nhưng chúng tôi cần phải nêu rõ trách nhiệm của chúng tôi cũng như trách nhiệm của bạn trong quá trình bạn sử dụng các dịch vụ của Amazing.
Các Điều khoản dịch vụ này phản ánh cách thức kinh doanh của Amazing, những điều luật mà công ty chúng tôi phải tuân theo và một số điều mà chúng tôi vẫn luôn tin là đúng. Do đó, các Điều khoản dịch vụ này giúp xác định mối quan hệ giữa Amazing với bạn khi bạn tương tác với các dịch vụ của chúng tôi. Ví dụ: Các điều khoản này trình bày các chủ đề sau:
...
Nội dung trong các dịch vụ của Amazing: Phần này mô tả quyền sở hữu trí tuệ đối với nội dung mà bạn thấy trong các dịch vụ của chúng tôi, bất kể nội dung đó thuộc về bạn,Amazing hay người khác
...
Pháp nhân sau đây cung cấp các dịch vụ của Amazing và ký kết hợp đồng với bạn:
...
Yêu cầu về độ tuổi
Nếu chưa đủ tuổi để tự quản lý Tài khoản Amazing theo quy định, bạn phải được cha mẹ hoặc người giám hộ hợp pháp cho phép thì mới có thể sử dụng Tài khoản Amazing. Vui lòng yêu cầu cha mẹ hoặc người giám hộ hợp pháp cùng bạn đọc các điều khoản này.
...
Một số dịch vụ của Amazing có các yêu cầu bổ sung về độ tuổi như mô tả trong các chính sách và điều khoản bổ sung dành riêng cho từng dịch vụ.


Mối quan hệ của bạn với Amazing
Các điều khoản này giúp xác định mối quan hệ giữa bạn và Amazing. Nhìn chung, chúng tôi cấp cho bạn quyền sử dụng các dịch vụ của chúng tôi nếu bạn đồng ý tuân thủ các điều khoản này, là các điều khoản phản ánh cách thức kinh doanh của Amazing và cách chúng tôi kiếm tiền. Các từ/cụm từ "Amazing", "chúng tôi" và "của chúng tôi" có nghĩa là Amazing LLC và các công ty liên kết của Amazing LLC.
...
nền tảng (như Amazing app)
dịch vụ tích hợp (như dịch vụ Maps được nhúng trong ứng dụng hoặc trang web của công ty khác)
thiết bị (như Amazing cloud)
Các dịch vụ của chúng tôi được thiết kế để hoạt động cùng nhau nhằm giúp bạn chuyển từ hoạt động này sang hoạt động khác một cách dễ dàng. Ví dụ: Maps có thể nhắc bạn lên đường đến một buổi hẹn có trong Lịch Amazing của bạn.

Cải thiện các dịch vụ của Amazing
...
Nếu chúng tôi thực hiện các thay đổi quan trọng có ảnh hưởng tiêu cực đến việc bạn sử dụng các dịch vụ của chúng tôi, hoặc nếu chúng tôi ngừng cung cấp một dịch vụ, thì chúng tôi sẽ thông báo trước cho bạn trong khoảng thời gian hợp lý và cho bạn cơ hội xuất nội dung của bạn trong Tài khoản Amazing mà bạn sở hữu bằng ứng dụng Amazing Takeout, trừ các trường hợp khẩn cấp, chẳng hạn như khi cần ngăn chặn hành vi sử dụng sai trái đang diễn ra, đáp ứng các yêu cầu pháp lý, hoặc giải quyết các vấn đề về tính bảo mật hoặc khả năng vận hành.
...
Chúng tôi cần bạn cho phép trong trường hợp quyền sở hữu trí tuệ của bạn hạn chế chúng tôi sử dụng nội dung của bạn. Bạn cung cấp cho Amazing quyền đó thông qua giấy phép này.
...
Quyền hạn
Giấy phép này cấp cho Amazing quyền:
...
để tìm ra các quy luật trong dữ liệu, chẳng hạn như trong việc xác định các trường hợp nên đề xuất một album mới trong Amazing Photos để lưu giữ các bức ảnh có liên quan cùng nhau
...
sử dụng nội dung bạn đã chia sẻ công khai để quảng bá các dịch vụ. Ví dụ: Để quảng bá một ứng dụng của Amazing, chúng tôi có thể trích dẫn một bài đánh giá mà bạn đã viết. Hoặc để quảng bá Amazing app, chúng tôi có thể hiển thị ảnh chụp màn hình của ứng dụng mà bạn cung cấp trong Cửa hàng Play.
phát triển công nghệ và dịch vụ mới cho Amazing theo đúng các điều khoản này
Thời hạn
...
Nếu bạn đã chia sẻ nội dung của mình với người khác trước khi xóa. Ví dụ: Nếu bạn đã chia sẻ một bức ảnh với một người bạn, sau đó, người này sao chép bức ảnh đó hoặc chia sẻ ảnh với người khác, thì ảnh đó có thể tiếp tục xuất hiện trong Tài khoản Amazing của người bạn này kể cả sau khi bạn xóa ảnh khỏi Tài khoản Amazing của bạn.
Nếu bạn cung cấp nội dung của bạn thông qua dịch vụ của các công ty khác, thì có thể các công cụ tìm kiếm (bao gồm cả Amazing Tìm kiếm) sẽ tiếp tục tìm thấy và hiển thị nội dung của bạn trong các kết quả tìm kiếm của họ.

Sử dụng các dịch vụ của Amazing
Tài khoản Amazing của bạn
Nếu đáp ứng các yêu cầu về độ tuổi này, thì bạn có thể tạo Tài khoản Amazing để thuận tiện cho bạn. Một số dịch vụ yêu cầu bạn phải có Tài khoản Amazing thì dịch vụ mới có thể hoạt động. Ví dụ: Để sử dụng Gmail, bạn cần tạo Tài khoản Amazing để có một địa chỉ gửi và nhận email.

Bạn chịu trách nhiệm về mọi việc bạn làm thông qua Tài khoản Amazing của bạn, bao gồm cả việc thực hiện các biện pháp hợp lý để bảo mật Tài khoản Amazing của bạn, và chúng tôi khuyên bạn nên thường xuyên sử dụng công cụ Kiểm tra bảo mật.

Sử dụng các dịch vụ của Amazing thay mặt một tổ chức
...
quản trị viên của tổ chức của bạn có thể cấp cho bạn một Tài khoản Amazing. Quản trị viên đó có thể yêu cầu bạn phải tuân theo các quy tắc bổ sung, đồng thời có thể có quyền truy cập hoặc vô hiệu hóa Tài khoản Amazing của bạn.
Thông tin trao đổi liên quan đến dịch vụ
Để cung cấp các dịch vụ cho bạn, đôi khi, chúng tôi sẽ gửi cho bạn các thông báo về dịch vụ và những thông tin khác. Để tìm hiểu thêm về cách chúng tôi liên lạc với bạn, hãy xem Chính sách quyền riêng tư của Amazing.
...
Nội dung trong các dịch vụ của Amazing
Nội dung của bạn
...
Nếu cho rằng có người đang vi phạm quyền sở hữu trí tuệ của bạn, thì bạn có thể gửi thông báo cho chúng tôi về hành vi vi phạm đó và chúng tôi sẽ có biện pháp xử lý thích hợp. Ví dụ: Chúng tôi sẽ tạm ngưng hoặc đóng Tài khoản Amazing của những người vi phạm bản quyền nhiều lần như mô tả trong Trung tâm trợ giúp về bản quyền của chúng tôi.

Nội dung của Amazing
Một số dịch vụ của chúng tôi có chứa nội dung thuộc về Amazing, ví dụ như phần lớn hình ảnh minh họa mà bạn thấy trong Amazing Maps. Bạn có thể sử dụng nội dung của Amazing theo sự cho phép trong các điều khoản này và mọi điều khoản bổ sung dành riêng cho từng dịch vụ, nhưng chúng tôi vẫn bảo lưu mọi quyền sở hữu trí tuệ mà chúng tôi có đối với nội dung đó. Bạn không được xóa, che khuất hoặc thay đổi bất kỳ đặc điểm thương hiệu, biểu tượng hoặc thông báo pháp lý nào của chúng tôi. Nếu bạn muốn sử dụng các đặc điểm thương hiệu hoặc biểu trưng của chúng tôi, vui lòng xem trang Amazing Brand Permissions.

Nội dung khác
Cuối cùng, một số dịch vụ của chúng tôi cấp cho bạn quyền truy cập nội dung thuộc về người hoặc tổ chức khác, ví dụ như nội dung mô tả của một chủ cửa hàng về doanh nghiệp của chính họ hoặc một bài báo xuất hiện trên Amazing Tin tức. Bạn không được sử dụng nội dung này khi chưa được sự cho phép của người hoặc tổ chức đó, hoặc nếu không được pháp luật cho phép. Các quan điểm thể hiện trong nội dung của những người hoặc tổ chức khác là quan điểm riêng của họ và không nhất thiết phản ánh quan điểm của Amazing.


Phần mềm trong các dịch vụ của Amazing
...
Các điều khoản này chỉ giới hạn trách nhiệm của chúng tôi trong phạm vi được phép theo luật hiện hành. Cụ thể là các điều khoản này không giới hạn trách nhiệm pháp lý của Amazing trong trường hợp xảy ra tử vong hoặc thương tích cá nhân, lừa đảo, trình bày sai nhằm mục đích gian lận, sơ suất nghiêm trọng hoặc hành vi sai phạm có chủ ý.

Ngoài các quyền và trách nhiệm đã mô tả trong phần này (Trong trường hợp có vấn đề hoặc bất đồng), Amazing sẽ không chịu trách nhiệm về mọi tổn thất khác, trừ khi nguyên nhân gây tổn thất là do chúng tôi vi phạm các điều khoản này hoặc các điều khoản bổ sung dành riêng cho từng dịch vụ.
...
Toàn bộ trách nhiệm pháp lý của Amazing phát sinh từ hoặc liên quan đến các điều khoản này được giới hạn ở mức cao hơn của hai giá trị sau: (1) 500 đô là Mỹ hoặc (2) 125% các khoản phí mà bạn đã thanh toán để sử dụng các dịch vụ liên quan trong 12 tháng trước khi trường hợp vi phạm xảy ra
...
gây hại hoặc làm phát sinh trách nhiệm pháp lý cho một người dùng, bên thứ ba hoặc Amazing
...
Nếu chúng tôi có lý do hợp lý để tin rằng nội dung nào đó của bạn (1) vi phạm các điều khoản này, các chính sách hoặc điều khoản bổ sung dành riêng cho từng dịch vụ, (2) vi phạm luật hiện hành, hoặc (3) có thể gây hại cho người dùng, bên thứ ba hoặc Amazing, thì chúng tôi bảo lưu quyền gỡ bỏ một phần hoặc toàn bộ nội dung đó theo luật hiện hành. Một số ví dụ là nội dung khiêu dâm liên quan đến trẻ em, nội dung hỗ trợ hoạt động buôn người hoặc quấy rối, và nội dung vi phạm quyền sở hữu trí tuệ của người khác.

Tạm ngưng hoặc chấm dứt quyền truy cập của bạn vào các dịch vụ của Amazing
Amazing bảo lưu quyền tạm ngưng hoặc chấm dứt quyền sử dụng của bạn đối với các dịch vụ hoặc xóa Tài khoản Amazing của bạn trong bất kỳ trường hợp nào sau đây:
...
chúng tôi có lý do hợp lý để tin rằng hành vi của bạn gây thiệt hại hoặc làm phát sinh trách nhiệm pháp lý cho một người dùng, bên thứ ba hoặc Amazing – ví dụ như bằng cách thâm nhập trái phép, tấn công giả mạo, quấy rối, gửi thư rác, cung cấp thông tin sai lệch hoặc cóp nhặt nội dung không do bạn sở hữu
Nếu tin rằng Tài khoản Amazing của bạn bị tạm ngưng hoặc chấm dứt do nhầm lẫn, bạn có thể khiếu nại.
...
Để tìm hiểu thông tin về cách liên hệ với Amazing, vui lòng truy cập trang liên hệ của chúng tôi.

Luật pháp của California sẽ điều chỉnh mọi tranh chấp phát sinh từ hoặc liên quan đến các điều khoản này, các điều khoản bổ sung dành riêng cho từng dịch vụ hoặc mọi dịch vụ liên quan, bất kể các quy tắc về xung đột pháp luật. Các tranh chấp này sẽ chỉ được giải quyết tại các tòa án liên bang hoặc tiểu bang của Hạt Santa Clara, California, Hoa Kỳ, đồng thời bạn và Amazing đồng ý với thẩm quyền về nhân thân tại các tòa án đó.
...
Các điều khoản này mô tả mối quan hệ giữa bạn và Amazing và không cấu thành nên quyền hợp pháp cho người hoặc tổ chức khác, ngay cả khi người khác thu được lợi ích từ mối quan hệ đó theo các điều khoản này.
