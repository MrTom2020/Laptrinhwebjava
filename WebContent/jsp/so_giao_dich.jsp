...
<div class="modal fade" role="dialog" aria-labelledby ="dangky" aria-hidden="true" id="dk1" tabindex="-1" style="border:0;">
   ...
   <jsp:include page="nav2.jsp" flush="true"></jsp:include>
    ...
    <article class="container" style="width:96%; height:50%;margin-top:5%;background:#ebebeb;">
     <jsp:include page="g_so_giao_dich.jsp" flush="true"></jsp:include>
    </article>
    <a href="http://localhost:8080/baocaoweb/jsp/so_giao_dich.jsp">Quay về</a>
