...
<article id="btrangchu1">
    <section class="container-fluid">
            <div class="col-sm-3" style="padding-bottom:10%;font-size:20px;"><button><a href="tintuc.jsp">Tin tức</a></button></div>
            <div class="col-sm-3" style="padding-bottom:10%;font-size:20px;"><button>Khuyến mãi</button></div>
            <div class="col-sm-3" style="padding-bottom:10%font-size:20px;"><button><a href="lienhe.jsp">Liên hệ</a></button></div>
