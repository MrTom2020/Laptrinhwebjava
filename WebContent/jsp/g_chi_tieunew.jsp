...
<link rel="stylesheet" type="text/css" href="../baocaoweb/css/main2.css">
<link rel="stylesheet" type="text/css" href="../baocaoweb/css/custom.css">
<link rel="stylesheet" type="text/css" href="../baocaoweb/css/customize.css">
<link rel="stylesheet" type="text/css" href="../baocaoweb/css/print.css">
<link rel="stylesheet" type="text/css" href="../baocaoweb/css/vendor.css">

<script src="../baocaoweb/js/vendor.js"></script>
...
<script src="../baocaoweb/js/tool-calculator.js"></script>



  <div class="wrap-filter" style="background-image: linear-gradient(to bottom right, #2eb84b, #fff);">
     <div class="wrap-control" >
         <a href="http://localhost:8080/baocaoweb/jsp/so_giao_dich.jsp" title="Bảng tổng quát"   class="btn-short" id="short-version">Bảng tổng quát</a><a href="http://localhost:8080/baocaoweb/jsp/bangchitiet.jsp" title="Bảng chi tiết" class="btn-long"   id="long-version">Bảng chi tiết</a> 
