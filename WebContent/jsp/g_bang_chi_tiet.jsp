...
<ul class="wrap-list-middle">
			...
			<a href="/vn/personal/giao-dich-cung-acb" title="GIAO DỊCH CÙNG ACB" class="lnk lnk-type-7"></a>
              ...
              <div class="wrap-middle-minimal-menu">
                    <ul>
                        <li>
                            <a href="#" title="Tôi đã lưu" class="lnk lnk-stuff-i-like btn-stuff-i-like">
                                <span class="num" id="numstuffmini">0</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://online.acb.com.vn" title="ACB online" class="lnk lnk-acb-online"> </a>
                        </li>
                    </ul>
                </div>

                <div class="wrap-bottom-minimal-menu">
                    <!-- ul class="list-user-control">
                        <li>
                            <a href="" title="Lời nhắn" class="lnk lnk-type-1 btn-call-me-back"> </a>
                        </li>
                        <li>
                            <a href="" title="Chat cùng ACB" class="lnk lnk-type-2 btn-click-to-chat"> </a>
                        </li>
                        
                        <li>
                            <a title="Công cụ tính toán" ref="/wps/portal/Home/tool"  class="lnk lnk-type-4"></a>
                        </li>
                         <li>
                            <a href="" title="Truy cập nhanh" class="lnk lnk-type-3 btn-rates-fees"> </a>
                        </li>
                    </ul -->
