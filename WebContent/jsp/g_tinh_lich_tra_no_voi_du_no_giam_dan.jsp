...
<div class="page_wrap bg1 ">
    <div class="page">
        ...
        <div class="caption">Công cụ tính toán</div>
         <ul class="leftnav">
			<jsp:include page="g_menu_thanh_cong_cu.jsp"></jsp:include>
          </ul>
         </div>
...
<table bgcolor="#fafafa" border="0" bordercolor="#e2e2e2" cellpadding="0" cellspacing="0" class="tbl-loan-repayment">
	<tbody>
		...
		<tr>
			...
			<td align="left" width="80%"><input class="txt-date" id="date" readonly="readonly" type="text" value="" tabindex="4"> <img alt="Chọn ngày" id="btnDate" src="../tainguyenkhac/hinh_anh/hinh/calendar-icon.gif"> <script type="text/javascript">//<![CDATA[
                        Calendar.setup({
                            inputField: "date",
                            trigger: "btnDate",
