...
<div class="modal fade" role="dialog" aria-labelledby ="dangky" aria-hidden="true" id="dk1" tabindex="-1" style="border:0;">
    ...
    <div id="chon">
               <form action="#" method="POST">
                  ...
                  <a href="#" class="btn btn-success col-sm-12">Tuần</a>
                    <br/>
                    <br/>
                    <br/>
                    <a href="#" class="btn btn-success col-sm-12">Tháng</a>
                    <br/>
                    <br/>
                    <br/>
                    <a href="#" class="btn btn-success col-sm-12" onclick="pleasewaiting();">Qúy</a>
                    <br/>
                    <br/>
                    <br/>
                    <a href="#" class="btn btn-success col-sm-12">Năm</a>
               </form> 
    </div>
