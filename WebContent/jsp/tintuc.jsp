...
<div class="modal fade" role="dialog" aria-labelledby ="dangky" aria-hidden="true" id="dk1" tabindex="-1" style="border:0;">
    ...
    <header id="hder">
        ...
        <button data-toggle="modal" data-target="#dn"  id="DN" style="margin-right: 20px;">đăng nhập</button>
        <button data-toggle="modal" id="dk"   data-target="#dk1"> Đăng ký</button>
    </header>
    <nav id="NAV" class="navbar nav-fill">
    <jsp:include page="nav.jsp" flush="true"></jsp:include>
    </nav>
    <aside class="main-app-container" name="gioithieu" style="height:100%;">
       
            <jsp:include page="g_tintuc1.jsp" flush="true"></jsp:include>
