...
String tenkc = request.getParameter("tenkhoanchitieu2");
String tien = request.getParameter("tiena2");
String ngaygd = request.getParameter("ngaygd2");
String moita = request.getParameter("mota2");;
String ma =(String) session.getAttribute("MA");
String sql4 = "{CALL themkhoanthu(?,?,?,?,?)}";
